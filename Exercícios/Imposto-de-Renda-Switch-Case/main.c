...
int main(void) {
  ...
  float liquido = 0;
  int verificador = 0,porcentagem = 0;
  float faixa = 0,faixa_2 = 0,faixa_3 = 0,faixa_4 = 0;
  float hr_semanal = 0,hr_extra = 0,hr_atraso = 0;
  float salario_hora = 0,salario_extra = 0,salario_atrasos = 0;
  float valetrans = 0,plasaude = 0, valerefei = 0,desct = 0;
  float imposto = 0,inss = 0,inss_2 = 0,inss_3 = 0,inss_4 = 0;
  float debito = 0,credito = 0;
  ...
  scanf("%f",&salario);
    ...
    porcentagem = (salario < 1412) ? printf("\nVocê está recebendo menos do que um salário minimo, recomendamos procurar a justiça. Dito isso, você está isento de imposto\n") : 0;
    ...
    porcentagem = (salario > 4664.68) ? 4 : porcentagem;
      ...
      verificador = (salario < 1412.01) ? 1 : verificador;
      verificador = (salario > 1412 && salario < 2666.69) ? 2 : verificador;
      verificador = (salario > 2666.68 && salario < 4000.04) ? 3 : verificador;
      verificador = (salario > 4000.03 && salario < 7786.03) ? 4 : verificador;
      verificador = (salario > 7786.02) ? 5 : verificador;
...
*/
  imposto = inss + inss_2 + inss_3 + inss_4;
  ...
  scanf("%f",&hr_extra);
  printf("\nDigite quantas horas de atraso você teve no mês: ");
  scanf("%f",&hr_atraso);
  ...
  printf("Insira aqui seu vale transporte: ");
  scanf("%f",&valetrans);
  printf("\nInsira aqui seu vale refeição: ");
  scanf("%f",&valerefei);
  printf("\nInsira aqui seu plano de saúde e odontologico: ");
  scanf("%f",&plasaude);
...
liquido = salario - taxa;
  ...
  imposto = inss + inss_2 + inss_3 + inss_4 + faixa + faixa_2 + faixa_3 + faixa_4;
